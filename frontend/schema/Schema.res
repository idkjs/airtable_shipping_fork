...
type rec skuOrderTrackingRecord = {
  ...
  shipDate: readWriteScalarRecordField<option<Airtable.airtableMoment>>,
  receivedTime: readWriteScalarRecordField<option<Airtable.airtableMoment>>,
...
and skuOrderRecord = {
  ...
  skuOrderBoxLines: relRecordField<
    multipleRelField<boxLineRecord>,
    readOnlyScalarRecordField<string>,
  >,
...
and skuRecord = {
  ...
  skuAttachments: readWriteScalarRecordField<array<Airtable.airtableAttachment>>,
}
...
and skuOrderTrackingTable = {
  ...
  shipDateField: tableSchemaField<skuOrderTrackingRecord, option<Airtable.airtableMoment>>,
  receivedTimeField: tableSchemaField<skuOrderTrackingRecord, option<Airtable.airtableMoment>>,
...
and skuTable = {
  ...
  skuAttachmentsField: tableSchemaField<skuRecord, array<Airtable.airtableAttachment>>,
}
...
and skuOrderRecordBuilder: (genericSchema, Airtable.airtableRawRecord) => skuOrderRecord = (
  gschem,
  rawRec,
) => {
  id: rawRec.id,
  ...
  skuOrderBoxLines: {
    rel: asMultipleRelField(
      getQueryableRelField(gschem, "skuOrderBoxLines", boxLineRecordBuilder, rawRec),
    ),
    scalar: getField(gschem, "skuOrderBoxLines").string.buildReadOnly(rawRec),
  },
  skuOrderBoxDest: {
    rel: asSingleRelField(
...
and skuRecordBuilder: (genericSchema, Airtable.airtableRawRecord) => skuRecord = (gschem, rawRec) => {
  id: rawRec.id,
...
and boxDestinationRecordBuilder: (genericSchema, Airtable.airtableRawRecord) => boxDestinationRecord = (
  gschem,
  rawRec,
) => {
  id: rawRec.id,
...
and boxRecordBuilder: (genericSchema, Airtable.airtableRawRecord) => boxRecord = (gschem, rawRec) => {
  id: rawRec.id,
...
and boxLineRecordBuilder: (genericSchema, Airtable.airtableRawRecord) => boxLineRecord = (
  gschem,
  rawRec,
) => {
  id: rawRec.id,
